import { useState, useEffect } from "react"; // Remove useRef
...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 py-24 relative overflow-hidden">
      ...
      {/* Background Logo - keep this section */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.button
            onClick={() => navigate('/contact')} // Changed from /register to /contact
      ...
      {/* Add Layout at the bottom */}
      <Layout className="relative z-0">
        <div className="h-[300px] bg-gradient-to-b from-transparent to-slate-900" />
      </Layout>
    </div>
  );
};
